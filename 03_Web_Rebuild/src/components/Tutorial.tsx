...
const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    highlightArea: 'none',
    tips: ['系统会自动选择最低成本的可用科技开始研究', '智子封锁期间研发速度会大幅降低，但不会完全停止', '研发「550W量子计算机」可以解除智子封锁'],
  },
  {
    icon: <Shield size={32} />,
    title: '面壁计划与威慑体系',
  ...
  // ===== 第四章：胜利条件 =====
  {
    ...
    title: '六大胜利路径',
    category: '胜利之路',
    description: '人类文明可以通过以下任一方式赢得最终胜利：\n\n🏆 征服胜利 — 所有外星文明灭亡或与你结盟\n🛡 威慑胜利 — 进入威慑纪元且有执剑人和高威慑值\n💾 数字永生 — 完成「数字方舟」科技\n🚀 流浪地球 — 完成行星发动机全系列科技\n🌑 黑域胜利 — 完成「黑域生成」科技\n⚡ 光速胜利 — 完成「光速飞船」科技',
    highlightArea: 'none',
    tips: ['数字永生需先研究：数字文明→数字生命→意识上传→数字方舟', '流浪地球路径最长，需要大量时间', '不同胜利路径适合不同的游戏风格'],
  },

...
void CCultureTecDepartmentPanel::OnBnClickedButtonSettarget()
{
	...
	CTecTree* pTree = earthCivi.GetTecTreeManager().GetTecTree(TT_CULTURETEC);
...
void CCultureTecDepartmentPanel::UpdateUI()
{
	...
	CTecTreeNode* pNode = earthCivi.GetTecTreeManager().GetTecTree(TT_CULTURETEC)->GetResearchTecNode();

...
class CProtonTecTreeDlg : public CDialog
{
	DECLARE_DYNAMIC(CProtonTecTreeDlg)

public:
	CProtonTecTreeDlg(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CProtonTecTreeDlg();

// 对话框数据
	enum { IDD = IDD_PROTON_TECTREE_DLG };

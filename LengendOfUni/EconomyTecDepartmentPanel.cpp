...
void CEconomyTecDepartmentPanel::OnBnClickedButtonSettarget()
{
	...
	CTecTree* pTree = earthCivi.GetTecTreeManager().GetTecTree(TT_ECONOMYTEC);
...
void CEconomyTecDepartmentPanel::UpdateUI()
{
	...
	CTecTreeNode* pNode = earthCivi.GetTecTreeManager().GetTecTree(TT_ECONOMYTEC)->GetResearchTecNode();

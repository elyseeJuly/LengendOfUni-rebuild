...
void CNuclearDepartmentPanel::OnBnClickedButtonSettarget()
{
	...
	CTecTree* pTree = earthCivi.GetTecTreeManager().GetTecTree(TT_NUCLEAR);
...
void CNuclearDepartmentPanel::UpdateUI()
{
	...
	CTecTreeNode* pNode = earthCivi.GetTecTreeManager().GetTecTree(TT_NUCLEAR)->GetResearchTecNode();

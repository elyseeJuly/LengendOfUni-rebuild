// CultureTecDepartmentPanel.cpp : 实现文件
//
...
IMPLEMENT_DYNAMIC(CCultureTecDepartmentPanel, CDialog)

CCultureTecDepartmentPanel::CCultureTecDepartmentPanel(CWnd* pParent /*=NULL*/)
	: CDialog(CCultureTecDepartmentPanel::IDD, pParent)
	, m_sWorker(_T(""))
	, m_sDirection(_T(""))
{
...
CCultureTecDepartmentPanel::~CCultureTecDepartmentPanel()
{
}

void CCultureTecDepartmentPanel::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CCultureTecDepartmentPanel, CDialog)
	ON_BN_CLICKED(IDC_BUTTON_SETTARGET, &CCultureTecDepartmentPanel::OnBnClickedButtonSettarget)
	ON_BN_CLICKED(IDC_BUTTON_CHGLEADER, &CCultureTecDepartmentPanel::OnBnClickedButtonChgleader)
	ON_BN_CLICKED(IDC_BUTTON_MODNUM, &CCultureTecDepartmentPanel::OnBnClickedButtonModnum)
END_MESSAGE_MAP()


// CCultureTecDepartmentPanel 消息处理程序

void CCultureTecDepartmentPanel::OnBnClickedButtonSettarget()
{
	CCultureTecTreeDlg dlg;
...
BOOL CCultureTecDepartmentPanel::OnInitDialog()
{
...
void CCultureTecDepartmentPanel::UpdateUI()
{
	CEarthCivilization &earthCivi = ((CLengendOfUniApp*)AfxGetApp())->m_game->GetEarthCivilization();
	CDepartment *department = (CDepartment*)earthCivi.GetDepartment(DT_CULTURETEC);
...
void CCultureTecDepartmentPanel::OnOK()
{
}

void CCultureTecDepartmentPanel::OnCancel()
{

}

void CCultureTecDepartmentPanel::OnBnClickedButtonChgleader()
{
...
void CCultureTecDepartmentPanel::OnBnClickedButtonModnum()
{
	CEarthCivilization &earthCivi = ((CLengendOfUniApp*)AfxGetApp())->m_game->GetEarthCivilization();
	CDepartment *department = (CDepartment*)earthCivi.GetDepartment(DT_CULTURETEC);
	int iNewCnt, iOldCnt;

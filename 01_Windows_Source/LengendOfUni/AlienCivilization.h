...
public:
	...
	void SetPersonality(AI_PERSONALITY personality) { m_personality = personality; }
	AI_PERSONALITY GetPersonality() { return m_personality; }
};

// EconomyTecDepartmentPanel.cpp : 实现文件
//
...
IMPLEMENT_DYNAMIC(CEconomyTecDepartmentPanel, CDialog)

CEconomyTecDepartmentPanel::CEconomyTecDepartmentPanel(CWnd* pParent /*=NULL*/)
	: CDialog(CEconomyTecDepartmentPanel::IDD, pParent)
	, m_sLeader(_T(""))
	, m_sWorker(_T(""))
	, m_sDirection(_T(""))
{
...
CEconomyTecDepartmentPanel::~CEconomyTecDepartmentPanel()
{
}

void CEconomyTecDepartmentPanel::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CEconomyTecDepartmentPanel, CDialog)
	ON_BN_CLICKED(IDC_BUTTON_SETTARGET, &CEconomyTecDepartmentPanel::OnBnClickedButtonSettarget)
	ON_BN_CLICKED(IDC_BUTTON_CHGLEADER, &CEconomyTecDepartmentPanel::OnBnClickedButtonChgleader)
	ON_BN_CLICKED(IDC_BUTTON_MODNUM, &CEconomyTecDepartmentPanel::OnBnClickedButtonModnum)
END_MESSAGE_MAP()


// CEconomyTecDepartmentPanel 消息处理程序

void CEconomyTecDepartmentPanel::OnBnClickedButtonSettarget()
{
	CEconomyTecTreeDlg dlg;
	CEarthCivilization &earthCivi = ((CLengendOfUniApp*)AfxGetApp())->m_game->GetEarthCivilization();
	CTecTree* pTree = earthCivi.GetTecTreeManager().GetTecTree(TT_INTERSTELLAR);
...
BOOL CEconomyTecDepartmentPanel::OnInitDialog()
{
...
void CEconomyTecDepartmentPanel::UpdateUI()
{
	CEarthCivilization &earthCivi = ((CLengendOfUniApp*)AfxGetApp())->m_game->GetEarthCivilization();
	CDepartment *department = (CDepartment*)earthCivi.GetDepartment(DT_ECONOMYTEC);
	CPersonManager &personMgr = ((CLengendOfUniApp*)AfxGetApp())->m_game->GetPersonManager();
	CTecTreeNode* pNode = earthCivi.GetTecTreeManager().GetTecTree(TT_INTERSTELLAR)->GetResearchTecNode();
...
void CEconomyTecDepartmentPanel::OnOK()
{
}

void CEconomyTecDepartmentPanel::OnCancel()
{
}

void CEconomyTecDepartmentPanel::OnBnClickedButtonChgleader()
{
...
void CEconomyTecDepartmentPanel::OnBnClickedButtonModnum()
{
	CEarthCivilization &earthCivi = ((CLengendOfUniApp*)AfxGetApp())->m_game->GetEarthCivilization();
	CDepartment *department = (CDepartment*)earthCivi.GetDepartment(DT_ECONOMYTEC);
	int iNewCnt, iOldCnt;

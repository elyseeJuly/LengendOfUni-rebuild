...
void CSpaceflightDepartmentPanel::OnBnClickedButtonSettarget()
{
	...
	CTecTree* pTree = earthCivi.GetTecTreeManager().GetTecTree(TT_MILITARY);
...
void CSpaceflightDepartmentPanel::UpdateUI()
{
	...
	CTecTreeNode* pNode = earthCivi.GetTecTreeManager().GetTecTree(TT_MILITARY)->GetResearchTecNode();

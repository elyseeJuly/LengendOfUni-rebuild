...
void CAstrosociologyDepartmentPanel::OnBnClickedButtonSettarget()
{
	...
	CTecTree* pTree = earthCivi.GetTecTreeManager().GetTecTree(TT_PHYSICS);
...
void CAstrosociologyDepartmentPanel::UpdateUI()
{
	...
	CTecTreeNode* pNode = earthCivi.GetTecTreeManager().GetTecTree(TT_PHYSICS)->GetResearchTecNode();
